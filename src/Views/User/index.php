        ...
        <aside class="container-right">
            ...
            <div class="patient-info-container">
                ...
                <label for="user-name">
                    ...
                    class="lucide lucide-user-search"><circle cx="10" cy="7" r="4"/><path d="M10.3 15H7a4 4 0 0 0-4 4v2"/><circle 
                    cx="17" cy="17" r="3"/><path d="m21 21-1.9-1.9"/></svg>   
                </label>
            ...
            <div class="patient-info-container">
                <div class="button-trash">
                    <a href="Apagar_Paciente" class="box-button-icon <?php echo $is_user_active ?>">
                        ...
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                        class="lucide lucide-trash-2"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path 
                        d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
                    </a>
                </div>
